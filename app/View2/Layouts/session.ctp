...
<link href="<?php echo $this->webroot ; ?>/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
	...
	<link href="<?php echo $this->webroot ; ?>/assets/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" />
				...
				<ul class="nav pull-right" >
					...
					<li class="dropdown " id="header_notification_bar">
						...
						<ul class="dropdown-menu extended_new notification">
							...
							<div align="right" style="background-color:#eee; padding:5px;color:#02689b;font-weight: bold;"><a href="#"> See all notifications <i class=" icon-circle-arrow-right"></i></a></div>
...
if(sizeof($result)>0)
{
	...
	?>
	<li  class=""  >
		<a href="<?php echo @$page_name; ?>">
		<i class="<?php echo $icon ; ?>"></i> <?php echo $module_name ; ?>
...
<li>
	...
	<i class="icon-home"></i> New Society Enrollment
	</a>					
</li>
<li>
