...
<a href="accounts_category_excel_hm" class="btn blue" style="float:right;">Export in Excel</a>
</div>
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// ?>
...
<center>
               <form method="post" id="contact-form"> 
                        ...
                        <tr>
                        <td>
			            <input type="text" name="cat_name" placeholder="Accounts Category" class="m-wrap medium" style="background-color:white !important;" id="cat">
						<label id="cat"></label>
			            </td>
                        </tr>
...
<?php /////////////////////////////////////////////////////////////////////////////////////////////////// ?>			   
			...
			<form method="post">
			<center>
					<div class="portlet box grey" style="width:60%;">
