  ...
  <div class="portlet box green">
	 ...
	 <div class="portlet-body form">
		...
		<form id="contact-form" method="POST" class="form-horizontal" enctype="multipart/form-data" onSubmit="return checkbox_validation()">
			...
			<div class="controls">
				<textarea class="span12 wysihtml5 m-wrap" rows="15" name="description" id="notice_pre"  placeholder="Please text here....." style="width:80%;" ></textarea>
				<label  id="notice_pre"></label>
		...
		<!---------------end visible-------------------------------->
		   ...
		   <div class="form-actions">
			 <button type="submit" class="btn green tooltips" data-placement="bottom" data-original-title="Click to publish your notice" name="publish"  >Publish</button>

			 &nbsp
			 <button type="submit" class="btn green tooltips" data-placement="bottom" data-original-title="Click to save your notice" name="draft" >Save as draft</button>
		   </div>
		</form>
		<!-- END FORM-->
	 </div>
