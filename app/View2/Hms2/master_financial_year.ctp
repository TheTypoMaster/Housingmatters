...
<input type="hidden" value="<?php echo $f1; ?>" name="fm" />
<input type="hidden" value="<?php echo $t1; ?>" name="tm" />
Are You Sure
</div> 
<div class="modal-footer">
<a href="master_financial_year" class="btn">Close</a>
<button type="submit" class="btn green" name="sub2" value="xyz">Confirm</button>
</div>
</div>
<!----alert-------------->	
</form>
