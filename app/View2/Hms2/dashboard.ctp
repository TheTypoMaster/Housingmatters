			...
			<table class="table shadow table-bordered table-advance table-hover">
				<thead>
					<tr >
						...
						<a href="discussion_forum" class="pull-right" style="font-size: 12px;" ><i class="icon-search" style="text-decoration: none;font-size: 14px;"></i></a>
						<a href="discussion_forum?new=1" class="pull-right"><i class="icon-plus" style="text-decoration: none;font-size: 14px;padding: 0px 5px 0px 0px;"></i></a>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					?>
					<tr>
						<td><a href="discussion_forum?t=<?php echo $discussion_id; ?>&list=0" class="" data-trigger="hover" data-placement="bottom" data-content="<?php echo $description; ?>" data-original-title="<?php echo $topic; ?>"> <?php echo $topic_cut; ?> </a></td>
					</tr>
					<?php } 
			...
			<table class="table shadow table-bordered table-advance table-hover">
				<thead>
					<tr >
						...
						<a href="events" class="tooltips pull-right" style="font-size: 12px;"> <i class="icon-search" style="text-decoration: none;font-size: 14px;"></i></a>
						<a href="event_add" class="pull-right"><i class="icon-plus" style="text-decoration: none;font-size: 14px;padding: 0px 5px 0px 0px;"></i></a>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					?>
					<tr>
						<td><a href="event_info?e=<?php echo $event_id; ?>"> <?php echo $e_name_cut; ?> </a></td>
					</tr>
					<?php }
			...
			<table class="table shadow table-bordered table-advance table-hover">
				<thead>
					<tr >
						...
						<a href="<?php echo $url_see_all; ?>" class="pull-right" style="font-size: 12px;" ><i class="icon-search" style="text-decoration: none;font-size: 14px;"></i></a>
						<a href="help_desk_genarate_ticket" class="pull-right"><i class="icon-plus" style="text-decoration: none;font-size: 14px;padding: 0px 5px 0px 0px;"></i></a>
						</th>
					</tr>
				</thead>
				<tbody>
				...
				if($role_id==3) { 
				$url='help_desk_sm_view?id='.$help_desk_id.'&status='.$help_desk_status;
				}

				if($role_id!=3) { 
				$url='help_desk_r_view?id='.$help_desk_id.'&status='.$help_desk_status;
				}
				?>
					<tr>
						<td><a href="<?php echo $url; ?>"> <?php echo $ticket_id.' - '.$complain_name; ?> </a></td>
					</tr>
				<?php } 
			...
			<table class="table shadow table-bordered table-advance table-hover">
				<thead>
					<tr >
						...
						<a href="<?php echo $url_see_all; ?>" class="pull-right" style="font-size: 12px;" ><i class="icon-search" style="text-decoration: none;font-size: 14px;"></i></a>
						<a href="create_notice" class="pull-right"><i class="icon-plus" style="text-decoration: none;font-size: 14px;padding: 0px 5px 0px 0px;"></i></a>
					</tr>
				</thead>
				<tbody>
					<?php 
			...
			<table class="table shadow table-bordered table-advance table-hover">
				<thead>
					<tr >
						...
						<a href="Polls" class="pull-right" style="font-size: 12px;" ><i class="icon-search" style="text-decoration: none;font-size: 14px;"></i></a>
						<a href="poll_add" class="pull-right"><i class="icon-plus" style="text-decoration: none;font-size: 14px;padding: 0px 5px 0px 0px;"></i></a>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					?>
					<tr>
						<td><a href="Polls"> <?php echo $question_cut; ?> </a></td>
					</tr>
					<?php } 
			...
			<table class="table shadow table-bordered table-advance table-hover">
				<thead>
					<tr >
						...
						<a href="resource_view" class="pull-right" style="font-size: 12px;" ><i class="icon-search" style="text-decoration: none;font-size: 14px;"></i></a>
						<a href="resource_add" class="pull-right"><i class="icon-plus" style="text-decoration: none;font-size: 14px;padding: 0px 5px 0px 0px;"></i></a>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					?>
					<tr>
						<td><a href="resource_view"> <?php echo $resource_title_cut; ?> </a></td>
					</tr>
					<?php } 
