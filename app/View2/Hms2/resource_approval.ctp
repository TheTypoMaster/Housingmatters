...
$(document).ready(function() {
 ...
 var a_id=$(this).attr("ap_id");
 	...
 	$('#delete_topic_result').html('<div class="modal-backdrop fade in"></div><div   class="modal"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true"><div class="modal-body" style="font-size:16px;"><i class="icon-warning-sign" style="color:#d84a38;"></i> Are you sure you want to reject documents ? </div><div class="modal-footer"><a href="resource_reject?con='+a_id+'" class="btn blue" id="yes" >Yes</a><a href="#" role="btn" id="can" class="btn"> No </a>  </div></div>');
	$("#can").live('click',function(){
	$("#delete_topic_result").hide();
});
 });
