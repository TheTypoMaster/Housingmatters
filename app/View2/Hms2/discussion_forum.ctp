...
<a href="discussion_forum?t=<?php echo $t; ?>&list=0" role='button' rel="tab" class="btn" style=" background-color: #398439;color:#fff;" ><i class="icon-cloud"></i> All Topics</a>
<a href="discussion_forum?t=<?php echo $t; ?>&list=1" role='button' rel="tab" class="btn" style=" background-color: #d58512; color:#fff;"><i class="icon-heart"></i> My Topics</a>
<a href="discussion_forum?new=1" role='button' rel="tab" class="btn" style="background-color: #357ebd; color:#fff;"><i class=" icon-plus-sign"></i> Start Topic</a>
...
<a href="discussion_forum?t=<?php echo $t; ?>&list=2" role='button' rel="tab" class="btn black"><i class="icon-trash"></i> Archives</a>
</div>
...
<br/><br/>
<div style="padding-top:25px;"><input type="submit" class="btn green "  value="Start Topic" name="sub"></div>
...
?>
<?php if($list==0) { ?>
<a href="discussion_forum?t=<?php echo $discussion_post_id; ?>&list=0" role='button' rel="tab" style="text-decoration:none;">
...
<a href="discussion_forum?t=<?php echo $discussion_post_id; ?>&list=2" role='button' rel="tab" style="text-decoration:none;">
<div style="padding:2px;">
<div  style="background-color:#F4F8FF; cursor:pointer; color:#06F; padding:5px; border:solid 2px #D9E8FF;" class="topic sel" id="t1" >
<div align="center" style="font-size:18px;" ><?php echo $topic; ?></div>
<div align="center" ><span>(<?php echo $n_comments; ?> Comments )</span>&nbsp;&nbsp;<?php echo $date; ?>&nbsp;&nbsp; <?php echo $time; ?></div>
