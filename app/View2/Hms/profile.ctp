...
?>
                            ...
                            <div class="controls" style="width:100%;">
                                 <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div>
                                       <span class="btn btn-file mini black"><span class="fileupload-new">Edit</span>
  ...
  <!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
								...
								<div class="" id="accordion1" style="height: auto;">
									...
									<div class="" style="border:solid 0px white;">
										<div class="" style="background-color:#FBFBFB; padding-left:10px;">
                                            <table width="100%">
                                            <tr>
                                 ...
                                 <select class="span12 m-wrap" data-placeholder="Choose a Category" tabindex="1" name="sel_private" onchange="check_public(this.value)" id="check_id">
                                   <option value="mobile,0" >Public</option>
									...
									<div class="accordion-group" style="border:solid 0px white;">
										<div class="accordion-heading" style="background-color:#F5F5F5; padding-left:10px;">
											<table width="100%" >
                                        <tr>
 ...
 <!--////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->      
                                ...
                                <div class="accordion collapse in" id="accordion2" style="height: auto;">
									...
									<div class="accordion-group" style="border:solid 0px white;">
										<div class="accordion-heading" style="background-color:#FBFBFB; padding-left:10px;">
                                            <table width="100%">
                                            <tbody><tr>
                                   ...
                                   <option value="sex,0">Public</option>
									...
									<div class="accordion-group" style="border:solid 0px white;">
										<div class="accordion-heading" style="background-color:#F5F5F5; padding-left:10px;">
											<table width="100%">
                                        <tbody><tr>
                                        <td width="55%"><span style="margin-left:40%; font-size:14px; color:#666;">Date of Birth</span></td>
                                       
                                        <td width="29%">
										  <input type="text" name="dob" class="m-wrap  date-picker" data-date-format="dd-mm-yyyy" value="<?php echo $da_dob ; ?>">
										</td>
                                 ...
                                 <select class="span12 m-wrap" data-placeholder="Choose a Category" tabindex="1" name="sel_private" onchange="check_public(this.value)" id="check_id">
                                   <option value="com_address,0">Public</option>
									...
									<div class="accordion-group" style="border:solid 0px white;">
                                        ...
                                        <td width="29%">
										 <input type="text" name="hob" class="m-wrap m-ctrl-medium "  value="<?php echo $hobbies ; ?>">
                                 ...
                                 <select class="span12 m-wrap" data-placeholder="Choose a Category" tabindex="1" name="sel_private" onchange="check_public(this.value)" id="check_id">
                                   <option value="hobi,0">Public</option>
									...
									<div class="accordion-group" style="border:solid 0px white;">
										...
										<option value="1" <?php if(@$blood_group==1){ ?> selected <?php } ?>> Group A </option>
										<option value="2" <?php if(@$blood_group==2){ ?> selected <?php } ?>> Group B </option>
										<option value="3" <?php if(@$blood_group==3){ ?> selected <?php } ?>> Group AB  </option>
										<option value="4" <?php if(@$blood_group==4){ ?> selected <?php } ?>> Group O  </option>
										</select>
										</div>
										</div>
