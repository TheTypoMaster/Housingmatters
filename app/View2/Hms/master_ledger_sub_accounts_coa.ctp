...
<div class="portlet-body">
  ...
  $result_la = $this->requestAction(array('controller' => 'hms', 'action' => 'ledger_account'),array('pass'=>array($ledger_id)));
                  ...
                  <a href="#myModal<?php echo $auto_id; ?>" role="button" class="btn mini black" data-toggle="modal">Delete</a>
                    </td>
                    </tr>           
					<?php $n++; } ?> 
                    </tbody>  
...
<button type="submit" class="btn blue" name="sub<?php echo $auto_id2; ?>">Confirm</button>
</div>
</div>                        
<?php } ?>                    
</form>                 
