...
<li class="active" ><a href="society_settings" >Society Settings</a></li>
</ul>
...
if($user_id==$s_user_id && $role_id==3)
{
...
<tr>
<td>
<span style='color:#3B6B96;font-size: 16px;font-weight: bold;'>12. Banned Words  </span><br><br>
