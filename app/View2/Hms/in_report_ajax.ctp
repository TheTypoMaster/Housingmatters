...
?>
<td style="text-align:center;"><?php echo $amt; ?></td>
<?php
}
}
$n=5;
...
?>
<td style="text-align:center;"><?php echo $amt2; ?></td>	
<?php
}
}
if($n == 5)
...
?>
<td style="text-align:center;"><?php echo $current_amt; ?></td>
<td style="text-align:center;"><?php if(!empty($over_due_amt)) { echo $over_due_amt; } else { echo "0"; } ?></td>
<td style="text-align:center;"><?php echo $penalty_amt; ?></td>
...
<?php } ?>
<th><?php echo $tt_noc_amt; ?></th>

<th><?php echo $tt_current_amt; ?></th>
<th><?php echo $tt_over_due_amt; ?></th>
<th><?php echo $total_penalty_amt; ?></th>
<th><?php echo $tt_gt_amt; ?></th>
</tr>
</table>
</div>
</center>
