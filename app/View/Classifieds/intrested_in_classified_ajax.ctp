...
<div style="padding:10px;">
	<div class="portlet box blue">
		<div class="portlet-title">
			<h4><i class="icon-phone-sign"></i> Inform to ad creator</h4>
			<div class="tools">
		...
		<div class="portlet-body">
			<table width="100%">
				<tr><td width="15%"><b>To:</b> </td><td><?php echo $to; ?></td></tr>
				<tr><td><b>Message:</b> </td><td><textarea class="span6 m-wrap type_message" rows="3"></textarea></td></tr>
			</table>
