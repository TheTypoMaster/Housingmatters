...
<table class="table table-bordered" valign="middle" cellpadding="0" id="myTable" style="background-color:white;">
	<tr id="tr1">
		...
		<td width="15%"><input type="text" class="span12 m-wrap textbox" name="mobile" id="mobile1" style="font-size:16px;  background-color: white !important;" placeholder="Mobile" value=""></td>
		<td width="10%">
		<div class="controls">
