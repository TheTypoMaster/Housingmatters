...
{
?>
<span class="btn mini "onclick="contact_add(<?php echo $c_h_id ; ?>,'<?php echo $mobile ; ?>','<?php echo $name ; ?>','<?php echo $email; ?>','<?php echo $web; ?>','<?php echo $service ; ?>');">edit</span> 
<?php } ?>
<?php 
if($role_id==3)
{
?>
<span ><a href="contact_handbook_delete?con=<?php echo $c_h_id ; ?>" class="btn mini" >Delete</a></span>
<?php } ?>
</div>
</div>
</div>
