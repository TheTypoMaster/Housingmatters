...
<a href="accounts_group_excel_hm" class="btn blue" style="float:right;">Export in Excel</a>
</div>
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// ?>
<center>
               <form method="post" id="contact-form"> 
					    ...
					    <tr>
						<td>
					    <select name="main_id" class="m-wrap medium" id="main">
                        ...
                        <tr>
                        <td>
			            <input type="text" name="cat_name" placeholder="Accounts Group" class="m-wrap medium" style="background-color:white !important;" id="nm">
						<label id="nm"></label>
			            </td>
                        </tr>
...
<?php /////////////////////////////////////////////////////////////////////////////////////////// ?>
	<br>
			...
			<center>
<div class="portlet box grey" style="width:70%;">
