...
$('#show_data').html('<div id="pp"><div class="modal-backdrop fade in"></div><div   class="modal"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true"><div class="modal-body" style="font-size:14px;"> Notices are Published. </div><div class="modal-footer"><a href="notice_approval_ajax?con='+n_id+'" class="btn blue" id="yes">Ok</a></div></div></div>');
...
var n_id=$(this).attr("ap_id");
$('#show_data').html('<div id="pp"><div class="modal-backdrop fade in"></div><div   class="modal"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true"><div class="modal-body" style="font-size:14px;"><i class="icon-warning-sign" style="color:#d84a38;"></i> Are you sure you want to reject notices ? </div><div class="modal-footer"><a href="notice_approval_reject?con='+n_id+'" class="btn blue" id="yes">Yes</a><a href="#"  role="button" id="can" class="btn">No</a></div></div></div>');
