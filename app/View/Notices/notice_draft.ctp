...
<tr class="odd gradeX">
    ...
    <td><a href="notice_edit/<?php echo $notice_id; ?>" role="button" class="btn mini yellow tooltips" data-placement="bottom" data-original-title="Click to edit the notice" data-toggle="modal"><i class=" icon-edit"></i> Edit Notice</a></td>
