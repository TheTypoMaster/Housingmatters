...
<td style="text-align:right;"><?php echo $due_amount; ?></td>
<td style="text-align:right;" class="hide_at_print"><a href="ac_statement_bill_view/<?php echo $receipt_id; ?>" class="btn mini yellow" target="_blank">View Bill</a></td>
</tr>
...
<th style="text-align:right;"><?php echo $grand_total_amount; ?></th>
<th style="text-align:right;"><?php echo $total_due_amount; ?></th>
