...
<br />
<center>
       <a href="<?php echo $this->webroot; ?>Incometrackers/master_rate_card" class="btn purple" rel='tab'>Rate Card Add</a>     
       <a href="<?php echo $this->webroot; ?>Incometrackers/master_rate_card_view" class="btn yellow" rel='tab'>Rate Card View / Update</a> 
       </center>    
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////// ?>            
   <!-- <form method="post">
