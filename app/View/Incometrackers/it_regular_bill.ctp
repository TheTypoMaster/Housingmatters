...
{	
?>
    <div style="background-color:#fff;padding:5px; width:99%; overflow:auto visible; border:solid 1px #CCC;" class="form_div">
...
<div style="width:45%; background-color:#FFF; float:left;">
