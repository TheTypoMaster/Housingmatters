...
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////// ?>            
          ...
          <!--  <table width="100%" border="1" bordercolor="#FFFFFF" cellpadding="0">
           ...
           <table  align="center" border="1" bordercolor="#FFFFFF" cellpadding="0">
            ...
            <td>
            <a href="<?php echo $this->webroot; ?>Incometrackers/it_setup" class="btn" style="font-size:16px;" rel='tab'>Terms & Condition</a>
            </td>
            <td>
            <a href="<?php echo $this->webroot; ?>Incometrackers/master_rate_card" class="btn" style="font-size:16px;" rel='tab'>Rate Card</a>
            </td>
            <td>
            <a href="<?php echo $this->webroot; ?>Incometrackers/master_noc" class="btn yellow" style="font-size:16px;" rel='tab'>Non Occupancy Charges</a>
            </td>
            <td>
...
<br />            
<center>         
<a href="<?php echo $this->webroot; ?>Incometrackers/master_noc" class="btn purple" rel='tab'>Non Occupancy Charges Add</a>
<a href="<?php echo $this->webroot; ?>Incometrackers/master_noc_view" class="btn yellow" rel='tab'>Non Occupancy Charges View / Update</a>
</center>
            <br />
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////////// ?>  
<br /><br />
