...
<form method="post" id="contact-form" autocomplete="off">
    ...
    <div class="controls">
    &nbsp;&nbsp;&nbsp;<input type="text"  name="drawn_on_which_bank" class="m-wrap span9" placeholder="Drawn on which bank?" style="background-color:white !important;" id="ins" data-provide="typeahead" data-source="[<?php if(!empty($kendo_implode)) { echo $kendo_implode; } ?>]">
    &nbsp;&nbsp;&nbsp;<label id="ins"></label>
    </div>
    <br />
    </div>
