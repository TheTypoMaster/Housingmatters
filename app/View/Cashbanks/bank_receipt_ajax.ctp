...
<div class="controls">
<label class="radio">
<div class="radio" id="uniform-undefined"><span><input type="radio" name="rr_type" value="1" style="opacity: 0;" id="ttt"></span></div>
Maintenance
</label>
<label class="radio">
<div class="radio" id="uniform-undefined"><span><input type="radio" name="rr_type"  value="2" style="opacity: 0;" id="ttt"></span></div>
Other
</label>
<label id="ttt"></label>
</div>
