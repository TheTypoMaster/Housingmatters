...
if($this->RequestHandler->isAjax()){
	...
	echo file_get_contents('http://alerts.sinfini.com/api/v3/index.php?method=sms&api_key=A0cbbf83b328c37dd51dcf5066b7990f3&to=9636653883&sender=NMINVT&message=HELLO&format=json&custom=1,2&flash=0');
	exit;
